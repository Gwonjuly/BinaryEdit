...
def read_config_bin(file_path): 
    ...
    try:
        with open(file_path, "rb") as file:
            ...
            unpacked_data=struct.unpack("<5I 15I 1I 3I 13H 12B 8B 8B 27B 4B 12B 12B 12B 10B 16B", binary_data) 
            ...
            config_data.ubSerialNumber = bytes(unpacked_data[37:49])
            config_data.STLastDate = bytes(unpacked_data[49:57])
            config_data.SystemDataVersion = bytes(unpacked_data[57:65])
            config_data.ubAEDAnalyeOnOff = unpacked_data[65]
            config_data.ubAEDCPR_OnOff = unpacked_data[66]
            config_data.ubAEDCPR_Ratio = unpacked_data[67]
            config_data.ubPACERMode=unpacked_data[68]
            config_data.ubPACERCurrent=unpacked_data[69]
            config_data.ubPACERRate=unpacked_data[70]
            config_data.ubMONITOR_HR_Alarm_OnOff=unpacked_data[71]
            config_data.ubMONITOR_Pulse_Alarm_OnOff=unpacked_data[72]
            config_data.ubMONITOR_SpO2_Alarm_OnOff=unpacked_data[73]
            config_data.ubMONITOR_VF_VT_OnOff=unpacked_data[74]
            config_data.ubMONITOR_SpO2_High_Limits=unpacked_data[75]
            config_data.ubMONITOR_SpO2_Low_Limits=unpacked_data[76]
            config_data.ubMONITOR_AsystoleOnOff=unpacked_data[77]
            config_data.ubPRINTER_AutoModeOnOff=unpacked_data[78]
            config_data.ubECG_1ch_Lead=unpacked_data[79]
            config_data.ubECG_2ch_Lead=unpacked_data[80]
            config_data.ubECG_1ch_Gain=unpacked_data[81]
            config_data.ubECG_2ch_Gain=unpacked_data[82]
            config_data.ubManyLanguage=unpacked_data[83]
            config_data.ubAltLanguage=unpacked_data[84]
            config_data.ubLCDDisplayFilterRange=unpacked_data[85]
            config_data.ubPrinterFilterRange=unpacked_data[86]
            config_data.ubACFilterRange=unpacked_data[87]
            config_data.ubDEVICE_VoiceRecOnOff=unpacked_data[88]
            config_data.ubDEVICE_VolumeLevel=unpacked_data[89]
            config_data.ubDEVICE_QRSOnOff=unpacked_data[90]
            config_data.ubAlarmVolumeLevel=unpacked_data[91]
            config_data.reserved=bytes(unpacked_data[92:96])
            config_data.uNIBP_Mode=unpacked_data[96]
            config_data.uNIBP_AutoDuration=unpacked_data[97]
            config_data.uNIBP_AlarmOnOff=unpacked_data[98]
            config_data.uNIBP_AlarmTarget=unpacked_data[99]
            config_data.ubMONITOR_EtCO2_Alarm_OnOff=unpacked_data[100]
            config_data.ubMONITOR_EtCO2_High_Limits=unpacked_data[101]
            config_data.ubMONITOR_EtCO2_Low_Limits=unpacked_data[102]
            config_data.ubMONITOR_AwRR_Alarm_OnOff=unpacked_data[103]
            config_data.ubMONITOR_AwRR_High_Limits=unpacked_data[104]
            config_data.ubMONITOR_AwRR_Low_Limits=unpacked_data[105]
            config_data.ubCO2Unit=unpacked_data[106]
            config_data.ubMONITOR_NoBreath_Time=unpacked_data[107]
            config_data.ubEtCO2MAC=bytes(unpacked_data[108:120])
            config_data.ubEtCO2NAME=bytes(unpacked_data[120:132])
            config_data.ubCO2Scale=unpacked_data[132]
            config_data.ubCO2SweepSpeed=unpacked_data[133]
            config_data.ubPRINTER_PrintSectors=unpacked_data[134]
            config_data.ubEtCO2VolHighLimits=unpacked_data[135]
            config_data.ubEtCO2VolLowLimits=unpacked_data[136]
            config_data.ubECG_1ch_Sweep=unpacked_data[137]
            config_data.ubECG_2ch_Sweep=unpacked_data[138]
            config_data.ubTemperature_Unit=unpacked_data[139]
            config_data.ubEtCO2_PerVolO2=unpacked_data[140]
            config_data.ubEtCO2_PerVolN2O=unpacked_data[141]
            config_data.reserved2=bytes(unpacked_data[142:158])
...
def pack_config_data(config_data):
    ...
    packed_data = struct.pack(
        "<5I 15I 1I 3I 13H 12B 8B 8B 27B 4B 12B 12B 12B 10B 16B",
        ...
        if file_dialog.exec_():
            ...
            variable_order = [
               ...
               "usMONITOR_AlarmPauseTime", "ubPRINTER_ManualModeDuration", "uNIBP_SysHighLimits",
                ...
                "uNIBP_MapLowLimits","ubSerialNumber","STLastDate","SystemDataVersion","ubAEDAnalyeOnOff",
        ...
        try:
            if hasattr(self.config_data,filed_name):#syserrorcode in check
                ...
                if isinstance(attr_value, list):#attr_value type check, is it list?
                    arr_value=item.text().split()#parsing
